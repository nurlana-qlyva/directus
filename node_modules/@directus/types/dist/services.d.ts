...
interface FileService<T = File> {
     ...
     */
    uploadOne(stream: BusboyFileStream | Readable, data: Partial<T> & {
        storage: string;
...
export interface ExtensionsServices {
     ...
     * The ItemsService
     */
    ItemsService: new <T extends Item = Item, Collection extends string = string>(collection: Collection, options: AbstractServiceOptions) => AbstractService<T>;
    /**
     * The MailService
     */
